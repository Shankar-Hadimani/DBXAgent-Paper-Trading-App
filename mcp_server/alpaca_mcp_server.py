...
def _get_end_user_email() -> str:
    ...
    w = WorkspaceClient()
    return w.current_user.me().user_name or 'no@noemail.com'
...
@mcp.tool
def add_to_watchlist(symbol: str, email: str = "no@noemail.com") -> dict:
    """
...
@mcp.tool
def get_watchlist(limit: int = 100, email: str = 'no@noemail.com') -> dict:
    """
